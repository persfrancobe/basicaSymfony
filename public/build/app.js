...
$(document).ready(function () {
  ...
  $('#paginAjax').click(function () {
    $.ajax({
      ...
      method: 'GET',
      data: {},
      success: function success(responseSrv) {
